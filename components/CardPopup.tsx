...
const CardPopup = (card:UserQuestionDTO) => {
  ...
  return (
    <div>
<div className="fixed inset-0 z-50 bg-black bg-opacity-50 blur-md overflow-hidden pointer-events-none"></div>
    ...
    <div className="">
        <div className=" bg-white rounded-lg shadow text-sm w-[600px]">  
            <div className="px-6 py-4 border-b rounded-t text-gray-400">
                <h3 className="text-base font-semibold text-gray-900 lg:text-xl dark:text-white mb-5">
