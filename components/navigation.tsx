...
export default function Navigation() {
  ...
  return (
    <div className="">
    <nav className="bg-white  border-b font-semibold text-gray-400 ">
  ...
  <div className={`${
        ...
        <div className="flex  flex-col gap-2">
          ...
          <Link href="/metrics" className={`hover:text-gray-500 ${linkStyle("/problems")} flex gap-4`}>
        ...
        <Link href={'/'}>          <div className="flex items-center" >LeetTracker</div></Link>
