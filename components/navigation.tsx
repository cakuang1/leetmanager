...
export default function Navigation() {
  ...
  return (
    <nav className="bg-white flex justify-between border-b font-semibold text-gray-400 ">
      <div className="p-4">
      ...
      <div className="flex items-center justify-between p-2">
        <div className="flex space-x-4">
          <Link href="/problems" className={`hover:text-gray-500 ${linkStyle("/problems")}`}>

              Problems

          </Link>

          <Link href="/calendar" className={`hover:text-gray-500 ${linkStyle("/calendar")}`}>

             Calendar

          </Link>
          <Link href="/metrics" className={`hover:text-gray-500 ${linkStyle("/metrics")}`}>
